...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .hero-grid { display: grid; grid-template-columns: minmax(0, 1fr) minmax(0, 520px);
    gap: 38px; align-items: center; padding-block: 56px 30px; }
  h1 { font-size: clamp(30px, 4.6vw, 50px); line-height: 1.06; letter-spacing: -0.01em; }
  ...
  .stat-v { font-family: var(--mono); font-size: 30px; font-weight: 600; line-height: 1.05;
  ...
  .sec-head h2 { font-size: clamp(21px, 2.7vw, 27px); }
